...
function MedicalTreatmentPanel(){
    ...
    function showClickHandler () {
        window.alert("[" + "id = "+ treatId + ", CourseId = "+treatCourseId+ ", Type = "+ treattype +", Category = "+treatcategory+ ", Name = "+ patientname+ ", startDate = "+treatstartDate+ " ]");
    ...
    return(
        <div>
            ...
            <input placeholder="Treatment Type" value={treattype}  onChange = { e => setType(e.target.value)}  ></input>

            <br/>

            <input placeholder="Treatment Category" value={treatcategory}  onChange = { e => setCategory(e.target.value)}  ></input>
            
            <br/>

            <input placeholder="Patient Name" value={patientname}  onChange = { e => setName(e.target.value)}  ></input>

            <br/>

            <input placeholder="Treatment Start Date" value={treatstartDate}  onChange = { e => setStartDate(e.target.value)}  ></input>
